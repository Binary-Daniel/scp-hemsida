...
function L28() {
    ...
    var x = document.getElementById("exitl28");
    if (x.style.display === "block") {
        x.style.display = "none";
    } else {
        x.style.display = "block";
...
function L30() {
    ...
    var x = document.getElementById("exitl30");
    if (x.style.display === "block") {
        x.style.display = "none";
    } else {
        x.style.display = "block";
...
function L31() {
    ...
    var x = document.getElementById("exitl31");
    if (x.style.display === "block") {
        x.style.display = "none";
    } else {
        x.style.display = "block";
...
function L34() {
    ...
    var x = document.getElementById("exitl34");
    if (x.style.display === "block") {
        x.style.display = "none";
    } else {
        x.style.display = "block";
...
function L41() {
    ...
    var x = document.getElementById("exitl41");
    if (x.style.display === "block") {
        x.style.display = "none";
    } else {
        x.style.display = "block";
