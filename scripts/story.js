...
function AppendixA() {
    ...
    var x = document.getElementById("Appendix A");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit5");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Addendum013() {
    ...
    var x = document.getElementById("exit13");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Addendum014() {
    ...
    var x = document.getElementById("exit14");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Document281() {
    ...
    var x = document.getElementById("Document281");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit281");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Document282() {
    ...
    var x = document.getElementById("Document282");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit282");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Document283() {
    ...
    var x = document.getElementById("Document283");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit283");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Addendum030() {
    ...
    var x = document.getElementById("Addendum030");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit30");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Addendum031() {
    ...
    var x = document.getElementById("Addendum031");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit31");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function LabReport034() {
    ...
    var x = document.getElementById("LabReport034");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit341");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function PostInterrogationReport() {
    ...
    var x = document.getElementById("PostInterrogationReport");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit342");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Addendum0381() {
    ...
    var x = document.getElementById("Addendum0381");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit381");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Addendum0382() {
    ...
    var x = document.getElementById("Addendum0382");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit382");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Addendum0383() {
    ...
    var x = document.getElementById("Addendum0383");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit383");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Addendum0384() {
    ...
    var x = document.getElementById("Addendum0384");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit384");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Document0381() {
    ...
    var x = document.getElementById("Document0381");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit385");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Document0382() {
    ...
    var x = document.getElementById("Document0382");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit386");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function TestingLog038() {
    ...
    var x = document.getElementById("TestingLog038");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
function Addendum044(){
    ...
    var x = document.getElementById("Addendum044");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
    }
    var x = document.getElementById("exit44");
    if (x.style.display === "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
